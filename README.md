...
2. **반응형 디자인**
    - PC 퍼스트 접근
    - 브레이크포인트: 768px (모바일), 769 - 1366px (태블릿)
...
-   **PC/테블릿/모바일**: 모바일 768px, 테블릿 769 - 1366px 브레이크포인트
-   **이미지**: PC/모바일 버전 분리
-   **비디오**: PC/모바일 버전 분리
...
-   모든 디자인 공통 `css/ai/common/common.css`에서만 관리
-   변경 시 전체 프로젝트에 즉시 반영
-   서브 작업시 css 파일 확인 필수 `solution.css`,`solution_cy.css`
